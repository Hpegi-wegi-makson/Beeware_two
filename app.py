...
class HelloWorld(toga.App):
    def startup(self, widget=None):
        ...
        self.conn = sqlite3.connect('C://Users/Maksz//beeware-tutorial//database.db')  # таблицы
    ...
    def create_element_interface(self):
        ...
        self.login_button = toga.Button("Login: ", on_press=self.login_screen)  # login_scrin
        ...
        self.result = ''
        self.username_input_login = toga.TextInput(readonly=True, style=Pack(flex=1, ))
        ...
        self.password_input_login = toga.PasswordInput(readonly=True, style=Pack(flex=1))
        self.log_button = toga.Button("Login: ", on_press=self.сheck_to_register)
    ...
    def login_scrin(self, widget=None):
        ...
        self.main_box.remove(self.username_input_login)
    ...
    def login_screen(self, widget=None):
        self.main_box.add(self.username_input_login)
        self.main_box.add(self.username_label_login)
        self.main_box.add(self.password_input_login)
    ...
    def сheck_to_register(self, widget=None):
        ...
        self.cursor.execute(
            "INSERT INTO User (timestamp, login, password, result) VALUES (?, ?, ?, ?)",
